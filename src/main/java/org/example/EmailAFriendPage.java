...
public class EmailAFriendPage extends Utils{
    ...
    private String getExpectedErrorEmailMessage = "Email sent.";
    private By _emailErrorMessage = By.xpath("//li[text()=\"Only registered customers can use email a friend feature\"]");
    private String getExpectedEmailMessage = "Your message has not been sent.";
    ...
    public void fillInFriendAndYourEmail() {
        ...
        //enter message
        typeText(_personalMessage,"\"Hey, check out this awesome website!\"");
        //click on send email
